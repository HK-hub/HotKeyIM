...
/**
 * @author : HK意境
 * @ClassName : SpeechRecognitionUtil
 ...
 */
@Slf4j
public class SpeechRecognitionUtil extends AbstractClient {
    ...
    public SpeechRecognitionUtil(Credential credential, String region) {
        this(credential, region, new ClientProfile());
    }

    public SpeechRecognitionUtil(Credential credential, String region, ClientProfile profile) {
        super(SpeechRecognitionUtil.endpoint, SpeechRecognitionUtil.version, credential, region, profile);
    }
     ...
     * <br>•   支持中文普通话、英语、粤语、日语、越南语、马来语、上海话、四川话、武汉话、贵阳话、昆明话、西安话、郑州话、太原话、兰州话、银川话、西宁话、南京话、合肥话、南昌话、长沙话、苏州话、杭州话、济南话、天津话、石家庄话、黑龙江话、吉林话、辽宁话。
     * <br>•   支持本地语音文件上传和语音URL上传两种请求方式，音频时长不能超过60s，音频文件大小不能超过3MB。
     * <br>•   音频格式支持wav、pcm、ogg-opus、speex、silk、mp3、m4a、aac。
     * <br>•   请求方法为 HTTP POST , Content-Type为"application/json; charset=utf-8"
     * <br>•   签名方法参考 [公共参数](https://cloud.tencent.com/document/api/1093/35640) 中签名方法v3。
     * <br>•   默认接口请求频率限制：30次/秒，如您有提高请求频率限制的需求，请[前往购买](https://buy.cloud.tencent.com/asr)。
